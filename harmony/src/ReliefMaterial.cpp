...
ofShader ReliefMaterial::shaderNoTexture;
ofShader ReliefMaterial::shaderTexture2D;
ofShader ReliefMaterial::shaderTextureRect;
bool ReliefMaterial::shadersInitialized = false;
size_t ReliefMaterial::shaderLights = 0;
...
void ReliefMaterial::setDiffuseColor(ofFloatColor oDiffuse)
{
    data.diffuse = oDiffuse;
}

void ReliefMaterial::setAmbientColor(ofFloatColor oAmbient)
{
    data.ambient = oAmbient;
}

void ReliefMaterial::setSpecularColor(ofFloatColor oSpecular)
{
    data.specular = oSpecular;
}

void ReliefMaterial::setEmissiveColor(ofFloatColor oEmissive)
{
    data.emissive = oEmissive;
}

void ReliefMaterial::setShininess(float nShininess)
{
    data.shininess = nShininess;
}

void ReliefMaterial::setData(const ReliefMaterial::Data &data)
{
    this->data = data;
}

float ReliefMaterial::getShininess()const
{
    return data.shininess;
}

ofFloatColor ReliefMaterial::getDiffuseColor()const
{
    return data.diffuse;
}

ofFloatColor ReliefMaterial::getAmbientColor()const
{
    return data.ambient;
}

ofFloatColor ReliefMaterial::getSpecularColor()const
{
    return data.specular;
}

ofFloatColor ReliefMaterial::getEmissiveColor()const
{
    return data.emissive;
}

ReliefMaterial::Data ReliefMaterial::getData()const
{
    return data;
}

void ReliefMaterial::begin() const
{
    if (ofGetGLRenderer())
    {
...
void ReliefMaterial::initShaders(ofGLProgrammableRenderer & renderer) const
{
...
const ofShader & ReliefMaterial::getShader(int textureTarget, ofGLProgrammableRenderer & renderer) const
{
...
void ReliefMaterial::updateMaterial(const ofShader & shader, ofGLProgrammableRenderer & renderer) const
{
...
//TODO: modify this shader to support normal mapping
